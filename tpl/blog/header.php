...
<header class="header">
    <div class="navbar">
        ...
        <ul class="nav">
            ...
            <?php  }?>
            <li id="menu-item-99" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-56"><a href="/tool">小公举</a></li>
        </ul>
    ...
    <div class="speedbar">
        <!-- <div class="pull-right"><a href="">登录</a></div>-->
