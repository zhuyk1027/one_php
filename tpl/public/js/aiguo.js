(
    function() {
        ...
        document.body.addEventListener('click', function(e) {
            ...
            span.style.cssText = ['z-index: 9999999; position: absolute; font-weight: bold; color: #EA5D5A; top: ', y - 20, 'px; left: ', x, 'px;'].join('');
            document.body.appendChild(span);animate(span);}
        );
        function animate(el) {
